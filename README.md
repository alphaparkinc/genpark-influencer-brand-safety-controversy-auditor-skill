# genpark-influencer-brand-safety-controversy-auditor-skill
...
**genpark-influencer-brand-safety-controversy-auditor-skill** is a deterministic, zero-dependency Python skill engineered for autonomous creator operations, influencer marketing automation, and multi-agent campaign workflows.

> **Executive Capability**: Influencer brand safety & multi-year controversy history auditor (Traackr)
...
result = client.audit_creator_safety_history()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-influencer-brand-safety-controversy-auditor-skill": {
      "command": "python",
      "args": ["/path/to/genpark-influencer-brand-safety-controversy-auditor-skill/mcp_server.py"]
    }
  }
}
```
...
Explore the comprehensive directory of 1,140+ open-source, production-ready AI Agent skills at the [GenPark AI MCP Hub](https://genpark.ai/mcp) and learn more about agentic shopping and commerce at [GenPark AI](https://genpark.ai).
